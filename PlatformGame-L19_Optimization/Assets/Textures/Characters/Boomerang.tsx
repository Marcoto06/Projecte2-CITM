...
<tileset version="1.10" tiledversion="1.12.1" name="Boomerang" tilewidth="64" tileheight="64" tilecount="8" columns="8">
 <image source="Boomerang.png" width="520" height="64"/>
 <tile id="0">
  <animation>

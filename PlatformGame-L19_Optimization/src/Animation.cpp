...
int Animation::Func_GetFrameCount() const { return static_cast<int>(frames_.size()); }
...
int AnimationSet::Func_GetCurrentFrameIndex() const
{
    if (Has(currentName_))
    {
        return clips_.at(currentName_).Func_GetFrameCount();
    }
